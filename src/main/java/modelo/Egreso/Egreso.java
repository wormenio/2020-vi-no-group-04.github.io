...
public abstract class Egreso {
	...
	@OneToMany
	private Collection<MedioDePagoDeLaCompra> mediosDePago = new ArrayList<>();

	@OneToMany
	@JoinTable(name = "Documentos_comerciales_compras")
	...
	public void agregarMediosDePago(MedioDePago medioDePago, double monto){
		MedioDePagoDeLaCompra medioDePagoDeLaCompra = new MedioDePagoDeLaCompra();
	...
	public Collection<MedioDePagoDeLaCompra> getMediosDePago() {
		return mediosDePago;
	}
